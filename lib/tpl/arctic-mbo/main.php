...
<div id="wrapper">
  <div class="dokuwiki">
    ...
    <?php if(tpl_getConf('sidebar') == 'left') { ?>
      ...
      <?php if(!tpl_sidebar_hide()) { ?>
        <div class="left_sidebar">
          <?php if(!tpl_getConf('closedwiki') || (tpl_getConf('closedwiki') && isset($_SERVER['REMOTE_USER']))) tpl_searchform() ?>
    ...
    <?php } elseif(tpl_getConf('sidebar') == 'both') { ?>
      ...
      <?php if(!tpl_sidebar_hide()) { ?>
        <div class="left_sidebar">
          <?php if((tpl_getConf('search') == 'left') &&  (!tpl_getConf('closedwiki') || (tpl_getConf('closedwiki') && isset($_SERVER['REMOTE_USER'])))) tpl_searchform() ?>
          <?php tpl_sidebar('left') ?>
        </div>
        ...
        <div class="right_sidebar">
          <?php if((tpl_getConf('search') == 'right') && ( !tpl_getConf('closedwiki') || (tpl_getConf('closedwiki') && isset($_SERVER['REMOTE_USER'])))) tpl_searchform() ?>
          <?php tpl_sidebar('right') ?>
        </div>
      <?php } else { ?>
        <div class="page">
