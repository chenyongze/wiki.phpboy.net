...
$conf['hidepageinfo']               = 0;                            // Hide the page information (last edition, author)
$conf['hidesidebar']		    = 'edit,preview,admin,conflict,draft,recover,media'; //Hide the sidebar for the following actions
