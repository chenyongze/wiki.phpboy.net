...
$meta['hidesidebar']		  = array('multicheckbox', '_choices' => array('show','locked','edit','recover', 'preview','draft', 'search','revisions','diff','recent','index','backlink','conflict','login','register','resendpwd','denied','profile','admin','subscribe','media'));
//Setup vim:ts=2:sw=2:
?>
