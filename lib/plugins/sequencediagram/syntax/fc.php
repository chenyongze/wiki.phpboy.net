<?php
/**
 * DokuWiki Plugin flowchartdiagram (Syntax Component)
 *
...
class syntax_plugin_sequencediagram_fc extends DokuWiki_Syntax_Plugin {
    /**
    ...
    public function connectTo($mode) {
        $this->Lexer->addSpecialPattern('<flowchartdiagram>.*?</flowchartdiagram>',$mode,'plugin_sequencediagram_fc');
    }
